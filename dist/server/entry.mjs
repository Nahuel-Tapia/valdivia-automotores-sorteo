...
import { manifest } from './manifest_DRNHtJlX.mjs';
...
const _page7 = () => import('./pages/api/simulate-payment.astro.mjs');
const _page8 = () => import('./pages/api/tickets/live-status.astro.mjs');
const _page9 = () => import('./pages/api/tickets/seat-lock.astro.mjs');
const _page10 = () => import('./pages/api/webhooks/mercadopago.astro.mjs');
const _page11 = () => import('./pages/checkout.astro.mjs');
const _page12 = () => import('./pages/confirmacion.astro.mjs');
const _page13 = () => import('./pages/participar.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/simulate-payment.ts", _page7],
    ["src/pages/api/tickets/live-status.ts", _page8],
    ["src/pages/api/tickets/seat-lock.ts", _page9],
    ["src/pages/api/webhooks/mercadopago.ts", _page10],
    ["src/pages/checkout.astro", _page11],
    ["src/pages/confirmacion.astro", _page12],
    ["src/pages/participar.astro", _page13],
